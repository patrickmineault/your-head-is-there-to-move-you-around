...
class TestPvc1Loader(unittest.TestCase):
    def test_repeats(self):
        ...
        self.assertEqual(loader.total_electrodes, 127)
        ...
        self.assertEqual(loader.total_electrodes, 23)
        ...
        self.assertEqual(loader.total_electrodes, 1)
    ...
    def test_delays(self):
        loader = pvc1.PVC1("../data/crcns-ringach-data/", nt=9, ntau=7, nframedelay=0)
        ...
        loader = pvc1.PVC1("../data/crcns-ringach-data/", nt=1, ntau=7, nframedelay=0)
    ...
    def test_batching(self):
        loader = pvc1.PVC1("../data/crcns-ringach-data/", ntau=7)

        trainloader = torch.utils.data.DataLoader(loader, batch_size=8, shuffle=True)
    ...
    def test_sequential(self):
        ...
        self.assertEqual(
            loader.sequence[0]["spike_frames"][-1],
